...
export class ChecklistDatabase {
  ...
  initialize() {
    debugger
    let arr=Object.keys(TREE_DATA).map((key) => [Number(key), TREE_DATA[key]]);
    this.treeData =arr;
...
@Component({
  selector: 'app-treewithfilter',
  templateUrl: './treewithfilter.component.html',
  styleUrls: ['./treewithfilter.component.css'],
  providers:[ChecklistDatabase]
})
export class TreewithfilterComponent {
