...
export class ChecklistDatabase {
  ...
  get data(): TodoItemNode[] { return this.dataChange.value;  console.log('top',this.dataChange.value)}
  ...
  initialize() {
    ...
    console.log('top1',this.data)
    // Notify the change.
    this.dataChange.next(data);
    console.log('top2',this.data)
...
// filter treee
  filterChanged(event:any){
    ...
    // this.database.dataChange.value.filter(event.target.value);
    // this.database.dataChange.value.filter(item=>{if(item.item.includes('berri')){console.log(item)}})
    // this.database.dataChange.value.children.filter((item:any)=>{if(item.item.name.includes(event.target.value)){
      ...
      this.database.dataChange.subscribe((treeData1:any) => {
